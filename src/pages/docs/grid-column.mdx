...
You can use either
<ArbitraryValues property="grid-column/grid-column-start/grid-column-end" featuredClass="col-[span_16]" />

Or enter a start and end value for the col span
<ArbitraryValues property="grid-column/grid-column-start/grid-column-end" featuredClass="col-[span_16_/_span_16]" />
